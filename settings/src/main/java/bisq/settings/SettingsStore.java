...
import bisq.common.util.StringUtils; // Añadido para la corrección R283
...
public final class SettingsStore implements PersistableStore<SettingsStore> {
    ...
    public static SettingsStore fromProto(bisq.settings.protobuf.SettingsStore proto) {
        ...
        // CORRECCIÓN R283: Interceptamos los valores vacíos de Protobuf (usuarios antiguos)
        ...
        return new SettingsStore(Cookie.fromProto(proto.getCookie()),
                ...
                parsedCountryCode, // <-- Pasamos el valor corregido
                parsedCurrencyCode, // <-- Pasamos el valor corregido
